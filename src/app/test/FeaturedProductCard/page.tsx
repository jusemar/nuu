...
function FeaturedProductCard(props: FeaturedProductCardProps): ReactElement;
function FeaturedProductCard(): ReactElement;
function FeaturedProductCard(props?: FeaturedProductCardProps) {
  const dados = props?.id
    ? props
    : {
        id: "produto-demonstracao",
        image: "/produto-sem-foto.webp",
  ...
  return (
    <article
      className={`group relative w-full max-w-[280px] overflow-hidden rounded-2xl border border-gray-100 bg-gradient-to-b from-white to-gray-50 shadow-xl transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl ${className}`}
      data-product-id={id}
      itemScope
