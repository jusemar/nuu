...
function ProductCard(props?: ProductCardProps) {
  ...
  return (
    <article
      className={`group relative w-full max-w-[280px] overflow-hidden rounded-2xl bg-white shadow-lg transition-all duration-300 hover:-translate-y-1 hover:shadow-xl ${className}`}
      data-product-id={id}
      itemScope
