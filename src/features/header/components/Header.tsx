    ...
    <header className="sticky top-0 z-50 w-full border-b border-[#E5E7EB] bg-white">
      <div className="border-b border-[#E5E7EB]">
        <div className="mx-auto max-w-7xl px-3 sm:px-4 md:px-6">
          {/* No celular, ações e busca ocupam linhas independentes para não se comprimirem. */}
          <div className="grid min-w-0 grid-cols-[auto_1fr_auto] items-center gap-2 py-2 md:flex md:h-16 md:gap-4 md:py-0">
            ...
            <Logo className="min-w-0 justify-self-start" showName />
      ...
      {/* A navegação desktop existente permanece a partir de 768 px. */}
      <nav
